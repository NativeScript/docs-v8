---
title: Plain JavaScript Tutorial
---
...
We will be using JavaScript for this tutorial. To create a new app, run the CLI command `ns create` with the name of the application followed by `--js`.
