...
For more examples of what's possible, run the demo app (shown in the gif below) and check out the [app's `main-view-model.ts` file](https://github.com/tjvantoll/nativescript-IQKeyboardManager/blob/master/demo/app/main-view-model.ts).
...
For maintainer’s of this plugin’s source code: when the [IQKeyboardManager Podfile](https://github.com/tjvantoll/nativescript-IQKeyboardManager/blob/master/src/platforms/ios/Podfile) updates, you should generate new typings for for this plugin to reflect those changes.
