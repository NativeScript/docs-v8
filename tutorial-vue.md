...
This tutorial introduces you to the essentials of Vue by walking you through building an Example App with a Some Basic Functionalities and UIs.
...
To create a new NativeScript Vue application, run the CLI command `ns create` with the name of the application followed by the `--vue`.
